  ...
  return (
    <div>
      ...
      <div className="grid w-full grid-cols-2 gap-4">
        {(token0Allowance === undefined || token0Allowance < liquidityDelta || token0Allowance === 0n) &&
          !token0Approved && (
            <button
        ...
        {(token0Approved || (token0Allowance !== undefined && token0Allowance > liquidityDelta)) && (
          <button className="btn btn-secondary w-full transition-all mt-4" disabled>
            Approved
          </button>
        )}
        {(token1Allowance === undefined || token1Allowance < liquidityDelta || token1Allowance === 0n) &&
          !token1Approved && (
            <button
        ...
        {(token1Approved || (token1Allowance !== undefined && token1Allowance > liquidityDelta)) && (
          <button className="btn btn-secondary w-full transition-all mt-4" disabled>
            Approved
          </button>
        )}
